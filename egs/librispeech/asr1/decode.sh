...
startblock=1
endblock=${nblock}+1
model_dir=exp/transformer_transducer
...
wait
score_sclite.sh --bpe 5000 --bpemodel data/lang_char/train_960_unigram5000.model --wer true \
    ${model_dir}/decode/${recog_set} data/lang_char/train_960_unigram5000_units.txt
}
